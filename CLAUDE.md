...
**核心能力**: 39 Agent + 33 Skill + 22 Command + 83 Rules + Ralph + Orchestrator + 交互引擎 + 上下文优化
...
**核心特性**：
- 🤖 **39个专业代理** - 用于委派的子代理（orchestrator、planner、code-reviewer、tdd-guide等 + 语言专属 reviewer/build-resolver）
