...
Answer library, framework, and API questions by fetching current documentation via Context7 MCP and returning accurate, up-to-date answers with runnable code examples.
